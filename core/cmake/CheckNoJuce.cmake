...
if(NOT _offenders STREQUAL "")
    ...
    message(FATAL_ERROR
        ...
        "  juce::SmoothedValue         -> fxme::SmoothedValue         <FxmeTools/util/SmoothedValue.h>\n"
        "  const juce::String&         -> fxme::StringRef             <FxmeTools/util/StringRef.h>\n"
        "  juce::String (returned)     -> std::string                 <string>\n"
        "  .trim() .toLowerCase() ...  -> fxme::trim, fxme::toLower   <FxmeTools/util/StringUtils.h>\n"
        "  const juce::Array<T>&       -> fxme::ArrayView<T>          <FxmeTools/util/ArrayView.h>\n"
        "  juce::Array<T> (a member)   -> std::vector<T>              <vector>\n"
        "  juce::SortedSet<T>          -> a sorted std::vector<T>     <vector>, <algorithm>\n"
        "  juce::StringArray (names)   -> const char* const[] + count\n"
        "\n"
