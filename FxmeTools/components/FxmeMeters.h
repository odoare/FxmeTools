...
class HorizontalVuMeter : public juce::Component, public juce::Timer
{
public:
  HorizontalVuMeter(std::function<float()>&& maxValueFunction,
...
public:
  ...
  void paint(juce::Graphics& g) override
  {
    ...
    valBounds.setRight(xvu+valWidth);
    g.fillRect(valBounds);
    ...
    bounds.setRight(xvu);
    g.drawText(juce::String(level),bounds,juce::Justification::centred);
  }
  ...
  void setValueColour(juce::Colour newColour)
  {
    valueColour = newColour;
  }
